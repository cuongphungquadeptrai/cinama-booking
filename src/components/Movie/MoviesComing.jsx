  ...
  useEffect(() => {
    const fetchMovies = async () => {
      try {
        ...
        const filteredMovies = data.filter((movie) => movie.status === "CommingSoon");
    ...
    <div className="min-h-screen py-16 relative">
                ...
                {movies
                  ...
                  .map((movie) => (
                    ...
                    >
                      ...
                      <div className="p-4 bg-gray-800 text-white h-[120px] flex flex-col justify-between">
      ...
      {totalPages > 1 && (
        <>
          ...
          <button
            onClick={() => handlePageChange(currentPage + 1)}
            className="absolute right-0 top-0 h-full w-30 bg-gradient-to-l from-black/50 to-transparent hover:from-gray-700/70 hover:to-transparent text-white text-4xl font-bold flex items-center justify-center transition-all duration-300 z-20"
          >
            &rsaquo;
          </button>
        </>
